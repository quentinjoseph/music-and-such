...
<!-- Get Youtube Video ID -->
  ...
  <div class="album">
    ...
    <!-- Artist -->
    <div class="artist ">
      <a class="album-link" href="<?php the_permalink(); ?>"><h1> <?php echo $title; ?></a>
        <a <?php echo $isVid ? 'data-lity' : '' ?> href="<?php echo $videoURL; ?>" target="<?php echo $isVid ? '' : '_blank'  ?>" >
          <!-- <i class="fa fa-youtube-play" aria-hidden="true"></i>  -->
        </a>
      </h1>
      <h3 ><a class="artist-link" href="https://en.wikipedia.org/wiki/<?php echo $artistWiki; ?>" target="_blank"><?php echo $artist ?></a></h3>
    </div>
